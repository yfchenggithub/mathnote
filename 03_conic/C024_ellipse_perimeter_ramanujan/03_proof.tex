\begin{proofbox}
	...
	\end{description}
	\begin{center}
		\input{assets/tikz/C024_ramanujan_error_curve.tex}

		\vspace{0.4em}
		{\small 图：Ramanujan 椭圆周长近似公式的相对误差表现}
	\end{center}
	\medskip

	\begin{center}
		\resizebox{0.96\linewidth}{!}{%
			\input{assets/tikz/C024_three_formula_error_compare.tex}
		}

		\vspace{0.35em}
		{\small 图：三种椭圆周长近似公式的相对误差对比}
	\end{center}
	\medskip
