...
一个椭圆绕 $y$ 轴旋转一周，会形成一个像橄榄球一样的立体，它的体积等于 $a^2 b$ 乘以一个常数 $\frac{4}{3}\pi$，即体积与赤道半径的平方乘以极半径成正比。
...
当旋转轴改变时，$a$ 与 $b$ 的角色互换。绕 $y$ 轴体积正比于 $a^2b$，绕 $x$ 轴体积正比于 $ab^2$，体现出公式对半轴的对称性。
...
\textbf{体积只与$a^2b$有关，与$a$、$b$具体比例无关，但注意$a$是$x$轴半轴。}
